 ...
 */
public class NaturalMinorScale extends AbstractScale implements IPlayableScale {

    public NaturalMinorScale(String rootNote){
        super();
        ToneSize[] scaleShape = {ToneSize.WHOLE, ToneSize.HALF, ToneSize.WHOLE, ToneSize.WHOLE, ToneSize.HALF, ToneSize.WHOLE, ToneSize.WHOLE};
